  ...
  return (
    <>
        ...
        <div className=''>
            ...
            {/* <div className='flex justify-between items-center  border-b-2 border-b-black/50 py-1'>
                <h3 className='font-bold text-sm md:text-md'>Studies (Max)</h3>
                <h4>5</h4>
            </div> */}
            {/* only for special, regular,auxillary pioneers */}
            {userInfo?.minProfile === "Regular pioneer" && (
                <>
                    <h2 className='pt-3'>Pioneers Service Statistics</h2>
                    <p>(day start recording)</p>
                    <div className='flex justify-between items-center  border-b-2 border-b-black/50 py-1'>
                        <h3 className='font-bold text-sm md:text-md'>Hours left</h3>
                        <h4>5</h4>
                    </div>
                    <div className='flex justify-between items-center  border-b-2 border-b-black/50 py-1'>
                        <h3 className='font-bold text-sm md:text-md'>Hours/month</h3>
                        <h4>5</h4>
                    </div>
                    <div className='flex justify-between items-center  border-b-2 border-b-black/50 py-1'>
                        <h3 className='font-bold text-sm md:text-md'>Hours balance</h3>
                        <h4>-50</h4>
                    </div>
                </>
            )}
